<?php
class dewMineSkevraB extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineSkevraB";
        $this->imagePath = "img/ships/descariMine.png";
        $this->shipClass = "Skevra-B DEW Mine";
        ...
        $this->addPrimarySystem(new DualIonBolter(0, 1, 0, 0, 360));
        
        //0:primary, 1:front, 2:rear, 3:left, 4:right;
        $this->addPrimarySystem(new Structure(1, 6));

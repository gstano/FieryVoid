<?php
class dewMineSkevraC extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineSkevraC";
        $this->imagePath = "img/ships/descariMine.png";
        $this->shipClass = "Skevra-C DEW Mine";
		$this->occurence = "common";
		$this->variantOf = "Skevra-B DEW Mine";
        $this->isd = 2110;
        ...
        $this->addPrimarySystem(new LaserLance(0, 1, 0, 0, 360));

<?php
class dewMineOmrathB extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineOmrathB";
        $this->imagePath = "img/ships/centauriMine.png";
        $this->shipClass = "Omrath-B Nuclear Mine";
        ...
        $this->addPrimarySystem(new MineControllerDEW(0, 1, 0, 1, 6)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range/output, $accuracy 

<?php
class dewMineTirellA extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineTirellA";
        $this->imagePath = "img/ships/descariMine.png";
        $this->shipClass = "Tirell-A DEW Mine";
        ...
        $this->addPrimarySystem(new MineControllerDEW(0, 1, 0, 4, 4)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range/output, $accuracy 
        $this->addPrimarySystem(new PlasmaTorch(0, 1, 0, 0, 360));

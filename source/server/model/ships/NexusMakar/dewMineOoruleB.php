<?php
class dewMineOoruleB extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineOoruleB";
        $this->imagePath = "img/ships/descariMine.png";
        $this->shipClass = "Oorule-B DEW Mine";
        ...
        $this->addPrimarySystem(new MineControllerDEW(0, 1, 0, 9, 6)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range/output, $accuracy 
        $this->addPrimarySystem(new SensorSpear(0, 1, 0, 0, 360));

<?php
class captorMineNexoriB extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "captorMineNexoriB";
        $this->imagePath = "img/ships/eaMine.png";
        $this->shipClass = "Nexori-B Captor Mine";
        ...
        $this->addPrimarySystem(new CaptorMine(0, 1, 1, 0, 360, 8, 6, 1, 0, 16)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range, $accuracy, $diceType, $dice, $damageBonus 
